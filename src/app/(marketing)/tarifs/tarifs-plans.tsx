      ...
      <div className="inline-flex items-center bg-gray-100 rounded-full p-1">
        {(['mensuel', 'annuel'] as const).map((p) => (
          ...
          >
            ...
            {p === 'annuel' && (
              <span className="absolute -top-2.5 -right-3 bg-brand-gold text-brand-off text-[10px] font-bold px-1.5 py-0.5 rounded-full leading-none whitespace-nowrap">
                2 mois offerts
              </span>
            )}
          </button>
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl border-2 border-gray-200 shadow-sm p-8 flex flex-col">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 mb-4">PME 1-50 salariés · 5 postes / 20 opérations</p>
            <div className="flex items-baseline gap-1 h-14">
              ...
              <span className="text-gray-400 text-base">{prix.industrie.detail}</span>
            </div>
        ...
        <div className="relative bg-brand-navy rounded-2xl shadow-lg p-8 flex flex-col">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-brand-cream/60 mb-4">PME 50-250 salariés · Postes illimités</p>
            <div className="flex items-baseline gap-1 h-14">
              <AnimatePresence mode="wait">
                <motion.span
